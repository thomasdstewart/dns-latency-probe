...
def write_prometheus_textfile(
    *,
    ...
    lines = [
        "# HELP dns_latency_probe_run_success Whether the last probe run completed successfully.",
        "# TYPE dns_latency_probe_run_success gauge",
        f"dns_latency_probe_run_success{{{labels}}} 1",
        "# HELP dns_latency_probe_last_run_unixtime Unix time when probe started.",
        "# TYPE dns_latency_probe_last_run_unixtime gauge",
        f"dns_latency_probe_last_run_unixtime{{{labels}}} {run_started_unix}",
        "# HELP dns_latency_probe_queries_sent Total DNS queries sent during the run.",
        "# TYPE dns_latency_probe_queries_sent gauge",
        f"dns_latency_probe_queries_sent{{{labels}}} {stats.total_queries_sent}",
        "# HELP dns_latency_probe_matched_responses Matched DNS responses.",
        "# TYPE dns_latency_probe_matched_responses gauge",
        f"dns_latency_probe_matched_responses{{{labels}}} {stats.matched_responses}",
        "# HELP dns_latency_probe_unmatched_queries DNS queries without a matching response.",
        "# TYPE dns_latency_probe_unmatched_queries gauge",
        f"dns_latency_probe_unmatched_queries{{{labels}}} {stats.unmatched_queries}",
        ...
        "# TYPE dns_latency_probe_latency_min_seconds gauge",
        f"dns_latency_probe_latency_min_seconds{{{labels}}} {_format_float(stats.min_seconds)}",
        "# HELP dns_latency_probe_latency_max_seconds Maximum matched DNS latency in seconds.",
        "# TYPE dns_latency_probe_latency_max_seconds gauge",
        f"dns_latency_probe_latency_max_seconds{{{labels}}} {_format_float(stats.max_seconds)}",
        "# HELP dns_latency_probe_latency_mean_seconds Mean matched DNS latency in seconds.",
        "# TYPE dns_latency_probe_latency_mean_seconds gauge",
        ...
        (
            "# HELP dns_latency_probe_latency_over_1s_percent "
